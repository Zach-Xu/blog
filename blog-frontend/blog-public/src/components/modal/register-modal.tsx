...
const RegisterModal = () => {
    ...
    return (
        <div className={`${isRegisterModalShown ? 'visible' : 'invisible'}  text-white bg-image-cover overflow-y-auto overflow-x-hidden fixed flex top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-screen max-h-[100vh]`}
            onClick={closeModal}
        >
            <div className={`transition-transform  ease-in duration-500 relative p-4 w-full max-w-md max-h-full bg-[#222] rounded-2xl shadow`}
            ...
            >
                ...
                <div className="px-4 pb-4 md:px-5 md:pb-5">
                    <form className="space-y-4" onSubmit={register} >
                        ...
                        <div className='pt-4'>
                            <button type="submit" disabled={isPending} className={`${isPending ? 'cursor-not-allowed' : 'cursor-pointer'} w-full bg-gradient-pink flex  items-center space-x-4  justify-center focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center`}>
                                <span>
                                    Register
                                </span>
                                {
                        ...
                        <div className="text-sm font-medium ">
                            Already an account?
                            <button type='button' className="ml-2 hover:underline text-blue-500 font-bold"
