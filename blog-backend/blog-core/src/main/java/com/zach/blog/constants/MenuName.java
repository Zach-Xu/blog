...
public class MenuName {
    ...
    public static final String USER_EXPORT = "Export user";
    public static final String USER_IMPORT = "Import user";
    public static final String USER_PASSWORD_RESET = "Reset password";
    ...
    public static final String ROLE_EXPORT = "Export role";
